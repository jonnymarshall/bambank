...
const NewPayment = (props) => {
  ...
  return(
    <section class="section c-new-transfer">
      <div class="container">
        <h1 class="title is-5">New payment</h1>
        <div class="field">
          <div class="user-details is-flex">
            ...
            <div class="c-new-transfer--name">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="Text input" value={`${firstName}`} disabled></input>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control has-icons-left has-icons-right">
            <input class="input is-success" type="text" placeholder="Text input" placeholder="What's it for?" onKeyUp={(e) => handleReferenceChange(e)}></input>
        ...
        <div class="field has-icons-left">
          ...
          <p class="control">
            <input class="input" type="number" placeholder="Amount (£)" onKeyUp={(e) => handleAmountChange(e)} />
            <span class="icon is-small is-left">
          ...
          {!paymentAmountIsWithinBalance && <p class="help is-danger">Balance too low!</p>}
        </div>
